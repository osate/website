 ...
 * OSATE Core and Analysis Plugins
   1. PropertiesLinkingDiagnosticMessageProvider is in the wrong place ([#1316](https://github.com/repos/osate/osate2/issues/1316))
   1. Aadl2GlobalScopeProvider should be generalized ([#1309](https://github.com/repos/osate/osate2/issues/1309))
   1. Need instantiation method that does not create a file and returns issues ([#1297](https://github.com/repos/osate/osate2/issues/1297))
   1. Update core and analysis tests to new pattern ([#1291](https://github.com/repos/osate/osate2/issues/1291))
   1. Error message for duplicate property sets prints internal representation ([#1280](https://github.com/repos/osate/osate2/issues/1280))
   1. Aadl2 standlone plugin should not use Eclipse workbench classes ([#1273](https://github.com/repos/osate/osate2/issues/1273))
   1. ResultUtil is missing some support methods ([#1260](https://github.com/repos/osate/osate2/issues/1260))
   1. Annex processing assumes that it runs inside Eclipse ([#1257](https://github.com/repos/osate/osate2/issues/1257))
   1. Instantiation always creates error markers ([#1255](https://github.com/repos/osate/osate2/issues/1255))
   1. Tests should not use a workspace build ([#1254](https://github.com/repos/osate/osate2/issues/1254))
   1. Multiple problems have occurred pop-up ([#1243](https://github.com/repos/osate/osate2/issues/1243))
   1. Incorrect error text for feature group inverse error ([#1234](https://github.com/repos/osate/osate2/issues/1234))
   1. Incorrect error about feature directions in inverse feature group ([#1233](https://github.com/repos/osate/osate2/issues/1233))
   1. Check Unhandled Faults should be grouped with safety analyses ([#1231](https://github.com/repos/osate/osate2/issues/1231))
   1. AADL Navigator should have New -> AADL Project in context menu ([#1228](https://github.com/repos/osate/osate2/issues/1228))
   1. AADL resources which reference contributed properties are rebuilt needlessly ([#1145](https://github.com/repos/osate/osate2/issues/1145))
   1. IGlobalScopeProvider enhancement ([#1089](https://github.com/repos/osate/osate2/issues/1089))
   1. Remove unmaintained Lattix import plugin ([#1373](https://github.com/repos/osate/osate2/issues/1373))
   1. Update flow latency plugin for usability / consistency ([#1322](https://github.com/repos/osate/osate2/issues/1322))
   1. Resolute and Agree plugin dependencies are not optional ([#1293](https://github.com/repos/osate/osate2/issues/1293))
   1. Update core and analysis tests to new pattern ([#1291](https://github.com/repos/osate/osate2/issues/1291))
   1. Latency analysis result contains unnecessary data and description is not a section under Latency Analysis ([#1261](https://github.com/repos/osate/osate2/issues/1261))
   1. Latency analysis parameters are not passed in explicitly but via Preference settings ([#1250](https://github.com/repos/osate/osate2/issues/1250))
 * Error Model and Analysis Plugins
   1. Exception when serializing EMV2 ([#1327](https://github.com/repos/osate/osate2/issues/1327))
   1. EMV2 uses a string to identify a Resolute function instead of a reference ([#1302](https://github.com/repos/osate/osate2/issues/1302))
   1. Annex parser and linker should not be in a UI plugin ([#1268](https://github.com/repos/osate/osate2/issues/1268))
   1. Old FTA code is still present in the EMV2 feature ([#1157](https://github.com/repos/osate/osate2/issues/1157))
   1. Fault Tree Viewer without Modeling Nature ([#1101](https://github.com/repos/osate/osate2/issues/1101))
 ...
 * ALISA
   ...
   1. Resolute compute function result is not included in assure structure ([#1329](https://github.com/repos/osate/osate2/issues/1329))
   1. Icons for Failure and Error are confusing ([#1324](https://github.com/repos/osate/osate2/issues/1324))
   1. global requirements on connection, flow do not have target in assure instance ([#1323](https://github.com/repos/osate/osate2/issues/1323))
   1. Verify method registry uses identifier to refer to Resolute function rather than qualified name ([#1301](https://github.com/repos/osate/osate2/issues/1301))
   1. Alisa interface to Resolute has extra diagnostics ([#1300](https://github.com/repos/osate/osate2/issues/1300))
   1. Resolute and Agree plugin dependencies are not optional ([#1293](https://github.com/repos/osate/osate2/issues/1293))
   1. Incorrect result status when requirement target has no results from plugin analysis ([#1279](https://github.com/repos/osate/osate2/issues/1279))
   1. ALISA should examine both Failure and Error issues to determine verification success ([#1276](https://github.com/repos/osate/osate2/issues/1276))
   1. Return value from a Java verification method is not assigned to a compute variable and evaluated by the predicate ([#1275](https://github.com/repos/osate/osate2/issues/1275))
   1. Execution of latency analysis from ALISA does not hold on to AnalysisResult for successive result lookup ([#1272](https://github.com/repos/osate/osate2/issues/1272))
   1. Requirement predicate has execution error when compute variables have no values ([#1267](https://github.com/repos/osate/osate2/issues/1267))
   1. ALISA does not handle ResoluteFailExceptions ([#1266](https://github.com/repos/osate/osate2/issues/1266))
   1. global requirements on features and flows are not handled ([#1265](https://github.com/repos/osate/osate2/issues/1265))
   1. Update ALISA documentation on global requirements and guidance in writing verification methods ([#1259](https://github.com/repos/osate/osate2/issues/1259))
   1. Verification activity with method and requirement for feature incorrectly marked with error ([#1240](https://github.com/repos/osate/osate2/issues/1240))
   1. ALISA does not report negative latency results any more ([#1223](https://github.com/repos/osate/osate2/issues/1223))
 ...
 * OSATE Core and Analysis Plugins
   1. Fixed a class cast exception when generating fault tree ([#1163](https://github.com/repos/osate/osate2-core/issues/1163))
   2. Fixed error "representations.aird resource has been externally changed, should we reload it?" when opening a fault tree ([#1162](https://github.com/repos/osate/osate2-core/issues/1162))
   3. OSATE has been updated to Oxygen.3 ([#1155](https://github.com/repos/osate/osate2-core/issues/1155))
   4. Property set wizard now checks for name conflicts ([#1154](https://github.com/repos/osate/osate2-core/issues/1154))
   5. Fixed missing queuing latency on data ports and extra sampling latency on queuing ports ([#1152](https://github.com/repos/osate/osate2-core/issues/1152))
   6. Use correct Sirius version ([#1149](https://github.com/repos/osate/osate2-core/issues/1149))
   7. Added missing per byte computation when only wrapper data size given ([#1144](https://github.com/repos/osate/osate2-core/issues/1144))
   8. Include virtual bus latency contribution if requires VB ([#1143](https://github.com/repos/osate/osate2-core/issues/1143))
   9. Queuing latency now calculated correctly for sporadic or periodic threads ([#1142](https://github.com/repos/osate/osate2-core/issues/1142))
   10. On connections from outside a partition both major frame and offset latency were added for a given partition ([#1141](https://github.com/repos/osate/osate2-core/issues/1141))
   11. Use specified connection latency when binding target has no latency ([#1140](https://github.com/repos/osate/osate2-core/issues/1140))
   12. Latency contribution by virtual bus and sampling latency by buses and virtual buses are now included ([#1139](https://github.com/repos/osate/osate2-core/issues/1139))
   13. Global requirements added in assurance plans and system requirements were sometimes ignored ([#1137](https://github.com/repos/osate/osate2-core/issues/1137))
   14. Added hover support for verification activities ([#1136](https://github.com/repos/osate/osate2-core/issues/1136))
   15. Support **when** condition on requirements ([#1133](https://github.com/repos/osate/osate2-core/issues/1133))
   16. Flow latency analysis used wrong property in some cases ([#1127](https://github.com/repos/osate/osate2-core/issues/1127))
   17. Fixed a NullPointerException in Flow Latency Analysis ([#1126](https://github.com/repos/osate/osate2-core/issues/1126))
   18. Verification of global requirements on instance root only ([#1123](https://github.com/repos/osate/osate2-core/issues/1123))
   19. Fix handling of global requirements on connections in assure generation ([#1122](https://github.com/repos/osate/osate2-core/issues/1122))
   20. Updated Sirius to version 5.1.0 ([#1118](https://github.com/repos/osate/osate2-core/issues/1118))
   21. Added SWTBot GEF to Setup File ([#1116](https://github.com/repos/osate/osate2-core/issues/1116))
   22. Fixed typo in wizard title ([#1114](https://github.com/repos/osate/osate2-core/issues/1114))
   23. Updated documentation for the new AADL package wizard ([#1109](https://github.com/repos/osate/osate2-core/issues/1109))
   24. Removed dependency on D-Cace ([#1095](https://github.com/repos/osate/osate2-core/issues/1095))
   25. Cleaned up Assure execution engine - use of Issue and stand alone call of Resolute Claim Functions ([#1093](https://github.com/repos/osate/osate2-core/issues/1093))
   26. Instantiation failed when referencing a required mode in a property association. ([#1092](https://github.com/repos/osate/osate2-core/issues/1092))
   27. Fixed a gate logic optimization problem in fault tree generation ([#1088](https://github.com/repos/osate/osate2-core/issues/1088))
   28. **All** in error flows was not handled correctly in fault tree generation ([#1087](https://github.com/repos/osate/osate2-core/issues/1087))
   29. Improved test coverage for fault tree and cut set generation ([#1086](https://github.com/repos/osate/osate2-core/issues/1086))
   30. Added preference to select FHA version ([#1083](https://github.com/repos/osate/osate2-core/issues/1083))
   31. Fixed an XtextReconcilerJob error while editing text ([#1082](https://github.com/repos/osate/osate2-core/issues/1082))
   32. Asymmetric SOM handling ([#1079](https://github.com/repos/osate/osate2-core/issues/1079))
   33. Better separation of flow latency analysis from handler ([#1078](https://github.com/repos/osate/osate2-core/issues/1078))
   34. Fixed NPE in bound resource allocations analysis ([#1075](https://github.com/repos/osate/osate2-core/issues/1075))
   35. Weight analysis considered too many connections ([#1071](https://github.com/repos/osate/osate2-core/issues/1071))
   36. Connection bindings are now handled by fault tree generator ([#1062](https://github.com/repos/osate/osate2-core/issues/1062))
   37. Restructured preference settings ([#1061](https://github.com/repos/osate/osate2-core/issues/1061))
   38. Simplified analysis result data structure ([#1055](https://github.com/repos/osate/osate2-core/issues/1055))
   39. Safety Analysis documentation is now properly included in online help ([#1049](https://github.com/repos/osate/osate2-core/issues/1049))
   40. Latency Analysis documentation is now properly included online help ([#1048](https://github.com/repos/osate/osate2-core/issues/1048))
   41. AADL package wizard now checks for name conflicts ([#1044](https://github.com/repos/osate/osate2-core/issues/1044))
   42. Moved Resolute help to smaccm repo ([#1015](https://github.com/repos/osate/osate2-core/issues/1015))
   43. Integrated help text markdown to HTML conversion into build ([#1013](https://github.com/repos/osate/osate2-core/issues/1013))
   44. Updated splash screen ([#1010](https://github.com/repos/osate/osate2-core/issues/1010))
   45. ALISA dependency on Resolute/AGREE is now optional ([#926](https://github.com/repos/osate/osate2-core/issues/926))
   46. Fixed instantiation error with extended inverse feature group type ([#818](https://github.com/repos/osate/osate2-core/issues/818))
 * Graphical Editor
